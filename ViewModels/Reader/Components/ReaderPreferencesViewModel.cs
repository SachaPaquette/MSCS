...
namespace MSCS.ViewModels.Reader.Components
{
    public class ReaderPreferencesViewModel : BaseViewModel
    {
        ...
        public ReaderPreferencesViewModel(UserSettings? userSettings)
        {
